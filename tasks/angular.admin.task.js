...
var webpackConfig = require('../webpack.admin.config.js');

var Elixir = require('laravel-elixir');

var Task = Elixir.Task;

Elixir.extend('angularAdmin', function(src, output, outputFilename) {

	var baseDir = src || Elixir.config.assetsPath + '/lblog/admin';
