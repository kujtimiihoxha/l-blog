...
var webpackConfig = require('../webpack.blog.config.js');

var Elixir = require('laravel-elixir');

var Task = Elixir.Task;

Elixir.extend('angularBlog', function(src, output, outputFilename) {

	var baseDir = src || Elixir.config.assetsPath + '/lblog/blog';
	console.log(baseDir);
